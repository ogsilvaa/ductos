...
namespace Testing
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (RegistroInspeccionVisualRepositorio repositorio = new RegistroInspeccionVisualRepositorio())
            {
                repositorio.Actualizar(valorPrueba);
                Result = repositorio.BuscarPorId(17);

            }
            Console.WriteLine(valorPrueba.EstadoTuberia == Result.EstadoTuberia);
            Console.ReadLine();
        }
    }
}
