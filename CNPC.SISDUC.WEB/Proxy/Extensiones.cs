...
namespace CNPC.SISDUC.Web.Proxy
{
    ...
    public static class TuberiaAssembler
    {
        ...
        private static readonly ILog Log = LogManager.GetLogger(typeof(TuberiaAssembler));
        public static List<RegistroInspeccionVisualModel> ConvertToViewModel(this RegistroInspeccionVisualResponse request)
        {
            ...
            {
                Log.ErrorFormat(MensajeExcepcion.OcurrioError, Constantes.CaseDefault);
        ...
        {
            RegistroInspeccionVisualModel resultado = new RegistroInspeccionVisualModel
            {
                Id = request.Id,
